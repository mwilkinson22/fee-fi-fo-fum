...
export default app => {
	...
	app.put("/api/awards/:awardId/category/:categoryId", requireAdmin, awardController.updateCategory);
	app.put("/api/awards/:_id/votes", awardController.submitVotes);
	app.put("/api/awards/:_id", requireAdmin, awardController.updateAward);

	app.delete("/api/awards/:awardId/category/:categoryId", requireAdmin, awardController.deleteCategory);
